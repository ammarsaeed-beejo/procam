...
const Printersitems = document.getElementsByClassName("Printers");

PrintersPrintersitems.addEventListener("click", function (e) {
  const filteredItems = data.filter(item => item.type === e.currentTarget.dataset.type);
