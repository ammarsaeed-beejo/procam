...
const const accessoriesitems = document.getElementById("accessories");
...
accessoriesitems.addEventListener("click", function (e) {
  ...
  window.location.href = "./products.html";
})items = document.getElementById("const accessoriesitems = document.getElementById("accessories");
