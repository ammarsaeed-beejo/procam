...
const submitBtn = document.querySelector("#emailsubmit");
...
submitBtn.addEventListener("click", function () {
    ...
    db.doc(emailInput)
        ...
        .then(function () {
            document.getElementById("emailsubmit").innerHTML = "Done!";
            document.getElementById("emailsubmit").style.backgroundColor = 'red';
            alert("done");
        })
