...
var itme_specificationlink = localStorage.getItem("item-des");
...
document.getElementById("img").innerHTML = `
    <img style="width: 90%;" alt="img"
        src="${item_img}">
`;
console.log(itme_specificationlink);
document.getElementById(
  "specification"
).innerHTML = `<a  href="${itme_specificationlink}" id="View full specification">View full specification</a>`;
...
var products = [
  {
    ...
    specificationlink: itme_specificationlink,
  },
];
