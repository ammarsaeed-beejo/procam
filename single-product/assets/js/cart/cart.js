...
for (let index = 0; index < cartItems.length; index++) {
  ...
  <tbody>
  <tr>
                                            <td class="product-remove" style="width:12%";>
                                                <button  class="remove" aria-label="Remove this item" onclick="remove(${cartItems[index].id})">×</button>
                                            </td>
                                            <td class="product-thumbnail" style="width:11%";                                                <a href=;" #"="">
                                                <a href="#">
                                                    <img class="img-responsive" src="${cartItems[index].img}"  width="300" height="300   ">
                                                </a>
                                            </td>
                                            <td class="product-name" data-title="Product" style="width:20%";  >
                                                <h3 class="product-name product_title">
                                                    <a href="#" tabindex="0">${cartItems[index].name}</a>
                                                </h3>
                                            </td>
                                            <td class="product-quantity" data-title="Quantity"  style="width:20%";>
                                                <div class="quantity">
                                                    <span class="qty-label">Quantiy:</span>
                                                   <div class="control">

                                                   <input style="text-align: center;" type="text" data-step="1" min="1" max=""
                                                       name="quantity[25]" value="1" title="Qty" id="quentity"
                                                       class="input-qty input-text qty text" size="2"
                                            ...
                                            <td class="product-price" data-title="Price">
                                                <span class="price"><span class="kobolg-Price-amount amount">${cartItems[index].price} <span
                                                class="kobolg-Price-currencySymbol">JD</span></span></span>
                                            </td>
                      </tr>
                      </tbody>              
...
document.getElementById("order-total").innerHTML = `
  <th>Total</th>
                                                <td data-title="Total"><strong><span
                                                            class="kobolg-Price-amount amount">${total_price} <span
                                                                class="kobolg-Price-currencySymbol">JD </span></span></strong>
                                                </td>
